<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadUserInfo.aspx.cs" Inherits="TJEvaluationSystem.Pages.SuperManagerPages.WebForm1" %>
...
<head runat="server">
    ...
    <script src="../../script/SuperManager/UploadUserInfo.js" type="text/javascript"></script>
...
<body>
    ...
    <div>
        ...
        <ContentTemplate>
        <iframe id="FileUpload" name="FileUpload" src="FileUploadPage.aspx" frameborder="0" 
