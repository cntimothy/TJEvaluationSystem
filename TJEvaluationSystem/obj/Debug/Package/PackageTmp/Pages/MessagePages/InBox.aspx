...
<body>
        ...
        <table style="position: relative; left: 20px; height: 100%">
            <tr>
                <td style="padding: 1px;">
                    <input type="button" value="未读" id="unread_button" onclick="searchUnRead()" class="l-button"
                        style="width: 100px; height: 25px; font-size: 15px" />
                </td>
                <td style="width: 10px;">
                </td>
                <td style="padding: 1px;">
                    <input type="button" value="全部" id="all_button" onclick="searchAll()" class="l-button"
                        style="width: 100px; height: 25px; font-size: 15px" />
                </td>
                <td style="width: 10px;">
                </td>
    ...
    <br />
    <br />
    <div id="Messagegrid" style="margin: 0 auto">
    </div>
    ...
    <div class="Hidden">
        ...
        <asp:Button ID="SearchUnRead" runat="server" Text="Button" OnClick="SearchUnRead_Click"
            Style="display: none" />
        <asp:Button ID="SearchAll" runat="server" Text="Button" OnClick="SearchAll_Click"
            Style="display: none" />
    </div>
    </form>
