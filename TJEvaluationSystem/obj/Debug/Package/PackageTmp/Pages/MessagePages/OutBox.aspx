<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutBox.aspx.cs" Inherits="TJEvaluationSystem.Pages.MessagePages.OutBox" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../lib/ligerUI/js/plugins/ligerTextBox.js" type="text/javascript"></script>
    <script src="../../Script/Message/OutBox.js" type="text/javascript"></script>
</head>
<body>
     ...
     <div id="Messagegrid" style="margin:0 auto" ></div> 
      ...
      <div id="ShowDetailMessage" class="Hidden" style="text-align:center" >
          <div class="DetailMessage" style="border:3px solid #a3c0e8;width:500px;margin:0px auto;">
            ...
            <tr>
                <td align="right" class="tableKey">收信人:</td>
                <td align="left" class="tableValue">
                    <div class="ShowData">
                        <asp:Label ID="mReceiveId" runat="server" Text=""></asp:Label>
                    </div>
                </td>
            </tr>
            <tr>
