<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountManage.aspx.cs" Inherits="TJEvaluationSystem.Pages.AccountPages.AccountManage" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../Script/Account/AccountManage.js" type="text/javascript"></script>
...
<body>
    ...
    <div id="layout1" style="width:99.2%; margin:0 auto; margin-top:4px; "> 
        <div position="left"  title="账户管理" id="accordion1"> 
              <div title="账户管理" class="l-scroll">
                <ul id="tree1" style="margin-top:3px;"></ul>
             </div>              
        </div>
        <div position="center" id="framecenter"> 
            <div tabid="home" title="账户信息" style="height:300px" >
