<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FirstManagerHome.aspx.cs"
    Inherits="TJEvaluationSystem.Pages.FirstManagerPages.FirstManagerHome" %>
...
<head runat="server">
    ...
    <script src="../../Script/FirstManager/FirstManagerHome.js" type="text/javascript"></script>
    ...
    <div id="layout1" style="width: 99.2%; margin: 0 auto; margin-top: 4px;">
        <div position="left" title="人事处管理员" id="accordion1">
            ...
            <div title="管理考评" class="l-scroll">
                <ul id="tree4" style="margin-top: 3px;">
                </ul>
            </div>
        </div>
