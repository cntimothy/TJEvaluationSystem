        ...
        protected void IBLogin_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                ...
                if (userLevel.Substring(0, 5) == "10000")
                {
                    ...
                    {
                        Response.Redirect("Pages/SuperManagerPages/SuperManagerHome.aspx");
                    }
                    else
                    {
                        //登录失败
                ...
                else if (userLevel.Substring(0, 5) == "01000")
                {
                    ...
                    {
                        Response.Redirect("Pages/FirstManagerPages/FirstManagerHome.aspx");
                    }
                    else
                    {
                        //登录失败
                ...
                else if (userLevel.Substring(0, 5) == "00100")
                {
                    ...
                    {
                        Response.Redirect("Pages/SecondManagerPages/SecondManagerHome.aspx");
                    }
                    else
                    {
                        //登录失败
                ...
                else if (userLevel.Substring(0, 5) == "00010")
                {
                    ...
                    {
                        Response.Redirect("Pages/EvaluatorPages/EvaluatorHome.aspx");
                    }
                    else
                    {
                        //登录失败
