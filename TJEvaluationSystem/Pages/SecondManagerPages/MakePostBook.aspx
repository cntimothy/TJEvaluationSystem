             ...
             <div id="outline">
                <table style="position:relative;left:40px;">
                     ...
                     <tr style="height:20px">
                          <td style="font-size:16px;height:20px;width:auto"><asp:Label ID="Label4" runat="server" Text="1.用人单位："></asp:Label></td>
                          <td> <asp:TextBox ID="prbEmployer" runat="server"  CssClass="textbox2"  ></asp:TextBox></td>                         
                     </tr>
                      <tr style="height:20px">
                          <td style="font-size:16px;height:20px"><asp:Label ID="Label5" runat="server" Text="2.用工单位："></asp:Label></td>
                          <td><asp:TextBox ID="prbLaborUnit" runat="server"  CssClass="textbox2"  ></asp:TextBox></td>
                     </tr>
                      <tr style="height:20px">
                          <td style="font-size:16px;height:20px"><asp:Label ID="Label6" runat="server" Text="3.用工部门："></asp:Label></td>
                          <td><asp:TextBox ID="prbLaborDep" runat="server"  CssClass="textbox2"  ></asp:TextBox></td>
                          
                     </tr>
                      <tr style="height:20px">
                          <td style="font-size:16px;height:20px"><asp:Label ID="Label7" runat="server" Text="4.岗位名称："></asp:Label></td>
                          <td> <asp:TextBox ID="prbPostName" runat="server"  CssClass="textbox2"  ></asp:TextBox></td>
                     </tr>
                      <tr style="height:20px">
                          <td style="font-size:16px;height:20px"><asp:Label ID="Label8" runat="server" Text="5.岗位类别："></asp:Label></td>
                          <td> <asp:TextBox ID="prbPostType" runat="server"  CssClass="textbox2"  ></asp:TextBox></td>     
                     </tr>
                    </table>
               </div >
               <br />
               <div id="response" style="position:relative;left:40px;">
                     <asp:Label ID="Label2" runat="server" Text="二、岗位职责" style="font-size:18px;font-weight:600;text-align:left;"></asp:Label>
                     <br />
                     <asp:Label ID="Label3" runat="server" Text="(一)任职条件" style="font-size:17px;font-weight:600;text-align:left;"></asp:Label>
                     <br />
