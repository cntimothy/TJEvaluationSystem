...
<body>
    ...
    <div>
    <div id="EvaluatorTable" style="padding-top:5px;" class="Hidden">
            <table class="mytable">
            <tr>
                <td class="num">一</td>
                                ...
                                <table frame="void">
                                    <tr id="KeyResponse1" class="ViewTable">
                                        <td class="type3" style="border-top:none;border-left:none;">
                                            <div class="ShowKeyResponse1 ViewTable"><asp:Label ID="LKeyResponse1Name" runat="server" Text="Label"></asp:Label></div>
                                            <div class="EditKeyResponse1 EditTable"><asp:TextBox ID="TBKeyResponse1Name" runat="server" Width="95%"></asp:TextBox></div>
                                        </td>
                                        <td style="border-top:none;padding:0px">
                                            <table frame="void">
                                                <tr>
                                                    <td colspan="4" class="content1" style="border-top:none;border-left:none;border-right:none;">
                                                        <div class="ShowKeyResponse1 ViewTable"><asp:Label ID="LKeyResponse1Content" runat="server" Text="Label"></asp:Label></div>
                                                        <div class="EditKeyResponse1 EditTable"><asp:TextBox ID="TBKeyResponse1Content" runat="server" Width="98%"></asp:TextBox></div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="scoretype" style="border-bottom:none;border-left:none;width:100px">优（9~10）</td>
                                    ...
                                    <tr id="KeyResponse2" class="ViewTable">
                                        <td class="type3" style="border-top:none;border-left:none;">
                                            <div class="ShowKeyResponse2 ViewTable"><asp:Label ID="LKeyResponse2Name" runat="server" Text="Label"></asp:Label></div>
                                            <div class="EditKeyResponse2 EditTable"><asp:TextBox ID="TBKeyResponse2Name" runat="server" Width="95%"></asp:TextBox></div>
                                        </td>
                                        <td style="border-top:none;padding:0px">
                                            <table frame="void">
                                                <tr>
                                                    <td colspan="4" class="content1" style="border-top:none;border-left:none;border-right:none;">
                                                        <div class="ShowKeyResponse2 ViewTable"><asp:Label ID="LKeyResponse2Content" runat="server" Text="Label"></asp:Label></div>
                                                        <div class="EditKeyResponse2 EditTable"><asp:TextBox ID="TBKeyResponse2Content" runat="server" Width="98%"></asp:TextBox></div>
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <td class="fun EditTable" style="border-top:none;border-right:none;">
                                    ...
                                    <tr id="KeyResponse3" class="ViewTable">
                                        <td class="type3" style="border-bottom:none;border-left:none;">
                                            <div class="ShowKeyResponse3 ViewTable"><asp:Label ID="LKeyResponse3Name" runat="server" Text="Label"></asp:Label></div>
                                            <div class="EditKeyResponse3 EditTable"><asp:TextBox ID="TBKeyResponse3Name" runat="server" Width="95%"></asp:TextBox></div>
                                        </td>
                                        <td style="border-bottom:none;padding:0px">
                                            <table frame="void">
                                                <tr>
                                                    <td colspan="4" class="content1" style="border:none;">
                                                        <div class="ShowKeyResponse3 ViewTable"><asp:Label ID="LKeyResponse3Content" runat="server" Text="Label"></asp:Label></div>
                                                        <div class="EditKeyResponse3 EditTable"><asp:TextBox ID="TBKeyResponse3Content" runat="server" Width="98%"></asp:TextBox></div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="scoretype" style="border-bottom:none;border-left:none;">优（9~10）</td>
                                        ...
                                        <td class="fun EditTable" style="border-bottom:none;border-right:none;">
                                    ...
                                    <tr id="KeyResponse" class="EditTable">
                                       <td class="addName" style="border-top:none;border-bottom:none;border-left:none">
                                            岗位内容：<br/>
                                            <asp:TextBox ID="TBKeyResponseName" runat="server" Height="40px" Width="95%" TextMode="MultiLine" class="InputData"></asp:TextBox>
                                       </td>
                                       <td class="addContent" style="border-top:none;border-bottom:none;">
                                            岗位要求:<br/>
                                            <asp:TextBox ID="TBKeyResponseContent" runat="server" Height="40px" 
                                                Width="98%" TextMode="MultiLine" class="InputData"></asp:TextBox>
                                       </td>
                                ...
                                <table frame="void">
                                    ...
                                    <tr id="KeyAbility" class="EditTable">
                                       <td class="addName2" style="border-top:none;border-bottom:none;border-left:none;">
                                            ...
                                            <asp:Label ID="LKeyAbilityName" runat="server" Text="请选择指标" class="SelectNameData"></asp:Label>
                                       </td>
                                       <td style="border-top:none;border-bottom:none;padding:0px">
                                            <table frame="void">
                                                <tr>
                                                    <td class="addContent2" style="border-top:none;border-left:none;">
                                                        <asp:Label ID="LKeyAbilityContentA" runat="server" class="SelectContentData"></asp:Label>
                                                    </td>
                                                    <td class="addContent2" style="border-top:none;">
                                                        <asp:Label ID="LKeyAbilityContentB" runat="server" class="SelectContentData"></asp:Label>
                                                    </td>
                                                    <td class="addContent2" style="border-top:none;">
                                                        <asp:Label ID="LKeyAbilityContentC" runat="server" class="SelectContentData"></asp:Label>
                                                    </td>
                                                    <td class="addContent2" style="border-top:none;border-right:none;">
                                                        <asp:Label ID="LKeyAbilityContentD" runat="server" class="SelectContentData"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="scoretype" style="border-bottom:none;border-left:none;">优（9~10）</td>
                                ...
                                <table frame="void">
                                    ...
                                    <tr id="KeyAttitude" class="EditTable">
                                       <td class="addName2" style="border-top:none;border-bottom:none;border-left:none;">
                                            ...
                                            <asp:Label ID="LKeyAttitudeName" runat="server" Text="请选择指标" class="SelectNameData"></asp:Label>
                                       </td>
                                       <td style="border-top:none;border-bottom:none;padding:0px">
                                            <table frame="void">
                                                <tr>
                                                    <td class="addContent2" style="border-top:none;border-left:none;">
                                                        <asp:Label ID="LKeyAttitudeContentA" runat="server" class="SelectContentData"></asp:Label>
                                                    </td>
                                                    <td class="addContent2" style="border-top:none;">
                                                        <asp:Label ID="LKeyAttitudeContentB" runat="server" class="SelectContentData"></asp:Label>
                                                    </td>
                                                    <td class="addContent2" style="border-top:none;">
                                                        <asp:Label ID="LKeyAttitudeContentC" runat="server" class="SelectContentData"></asp:Label>
                                                    </td>
                                                    <td class="addContent2" style="border-top:none;border-right:none;">
                                                        <asp:Label ID="LKeyAttitudeContentD" runat="server" class="SelectContentData"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="scoretype" style="border-bottom:none;border-left:none;">优（9~10）</td>
                    ...
                    <table frame="void">
                        <tr id="Response1" class="ViewTable">
                            <td class="type4" style="border-top:none;border-left:none;">
                                <div class="ShowResponse1 ViewTable"><asp:Label ID="LResponse1Name" runat="server"></asp:Label></div>
                                <div class="EditResponse1 EditTable"><asp:TextBox ID="TBResponse1Name" runat="server" Width="95%"></asp:TextBox></div>
                            </td>
                            <td style="border-top:none;padding:0px">
                                <table frame="void">
                                    <tr>
                                        <td colspan="4" class="content1" style="border-top:none;border-left:none;border-right:none;">
                                            <div class="ShowResponse1 ViewTable"><asp:Label ID="LResponse1Content" runat="server"></asp:Label></div>
                                            <div class="EditResponse1 EditTable"><asp:TextBox ID="TBResponse1Content" runat="server" Width="98%"></asp:TextBox></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="scoretype" style="border-bottom:none;border-left:none;">优（9~10）</td>
                        ...
                        <tr id="Response2" class="ViewTable">
                            <td class="type4" style="border-top:none;border-left:none;">
                                <div class="ShowResponse2 ViewTable"><asp:Label ID="LResponse2Name" runat="server" ></asp:Label></div>
                                <div class="EditResponse2 EditTable"><asp:TextBox ID="TBResponse2Name" runat="server" Width="95%"></asp:TextBox></div>
                            </td>
                            <td style="border-top:none;padding:0px">
                                <table frame="void">
                                    <tr>
                                        <td colspan="4" class="content1" style="border-top:none;border-left:none;border-right:none;">
                                            <div class="ShowResponse2 ViewTable"><asp:Label ID="LResponse2Content" runat="server" Text="Label"></asp:Label></div>
                                            <div class="EditResponse2 EditTable"><asp:TextBox ID="TBResponse2Content" runat="server" Width="98%"></asp:TextBox></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="scoretype" style="border-bottom:none;border-left:none;">优（9~10）</td>
                        ...
                        <tr id="Response3" class="ViewTable">
                            <td class="type4" style="border-bottom:none;border-left:none;">
                                <div class="ShowResponse3 ViewTable"><asp:Label ID="LResponse3Name" runat="server" Text="Label"></asp:Label></div>
                                <div class="EditResponse3 EditTable"><asp:TextBox ID="TBResponse3Name" runat="server" Width="95%"></asp:TextBox></div>
                            </td>
                            <td style="border-bottom:none;padding:0px">
                                <table frame="void">
                                    <tr>
                                        <td colspan="4" class="content1" style="border:none;">
                                            <div class="ShowResponse3 ViewTable"><asp:Label ID="LResponse3Content" runat="server"></asp:Label></div>
                                            <div class="EditResponse3 EditTable"><asp:TextBox ID="TBResponse3Content" runat="server" Width="98%"></asp:TextBox></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="scoretype" style="border-bottom:none;border-left:none;">优（9~10）</td>
                            ...
                            <td style="border:none;padding:0px;">
                                <table frame="void">
                                    <tr id="Veto1" class="ViewTable">
                                        <td  class="VoteContent" style="border-top:none;border-left:none;height:45px;">
