...
<body>
    ...
    <div class="ToolBar">
        <table style="position: relative; left: 20px; height: 100%">
            <tr>
                ...
                <td style="padding: 1px;">
                    <input type="button" value="通过" id="pass_button" onclick="pass()" class="l-button"
                        style="width: 100px; height: 25px; font-size: 15px; display: none" />
                </td>
                <td style="width: 10px;">
                </td>
                <td style="padding: 1px;">
                    <input type="button" value="退回" id="sendback_button" onclick="sendback()" class="l-button"
                        style="width: 100px; height: 25px; font-size: 15px; display: none" />
                </td>
                <td style="width: 10px;">
                </td>
    ...
    <div id="box" class="Hidden">
            ...
            <table style="position: relative; left: 40px;">
                ...
                <tr style="height: 20px">
                    <td style="font-size: 16px; height: 20px; width: auto">
                        <asp:Label ID="Label2" runat="server" Text="1.用人单位："></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="prbEmployer" runat="server" CssClass="textbox2" ReadOnly="true"></asp:TextBox>
                    </td>
                </tr>
                <tr style="height: 20px">
                    ...
                    <td>
                        <asp:TextBox ID="prbLaborUnit" runat="server" CssClass="textbox2" ReadOnly="true"></asp:TextBox>
                    </td>
                </tr>
                <tr style="height: 20px">
                    <td style="font-size: 16px; height: 20px">
                    ...
                    <td>
                        <asp:TextBox ID="prbLaborDep" runat="server" CssClass="textbox2" ReadOnly="true"></asp:TextBox>
                    </td>
                </tr>
                <tr style="height: 20px">
                    <td style="font-size: 16px; height: 20px">
                    ...
                    <td>
                        <asp:TextBox ID="prbPostName" runat="server" CssClass="textbox2" ReadOnly="true"></asp:TextBox>
                    </td>
                </tr>
                <tr style="height: 20px">
                    <td style="font-size: 16px; height: 20px">
                    ...
                    <td>
                        <asp:TextBox ID="prbPostType" runat="server" CssClass="textbox2" ReadOnly="true"></asp:TextBox>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div id="response" style="position: relative; left: 40px;">
            <asp:Label ID="Label3" runat="server" Text="二、岗位职责" Style="font-size: 18px; font-weight: 600;
                text-align: left;"></asp:Label>
            <br />
            <asp:Label ID="Label4" runat="server" Text="(一)任职条件" Style="font-size: 17px; font-weight: 600;
                text-align: left;"></asp:Label>
            <br />
            <asp:Label ID="Label9" runat="server" Text="1.学历背景：" CssClass="label1"></asp:Label>
            <br />
            <asp:TextBox ID="prbEduBg" runat="server" CssClass="textbox1" TextMode="MultiLine"
                ReadOnly="true"></asp:TextBox>
            <br />
            <asp:Label ID="Label10" runat="server" Text="2.培训及资历：" CssClass="label1"></asp:Label>
            <br />
            <asp:TextBox ID="prbCertificate" runat="server" CssClass="textbox1" TextMode="MultiLine"
                ReadOnly="true"></asp:TextBox>
            <br />
            <asp:Label ID="Label11" runat="server" Text="3.工作经验：" CssClass="label1"></asp:Label>
            <br />
            <asp:TextBox ID="prbExperience" runat="server" CssClass="textbox1" TextMode="MultiLine"
                ReadOnly="true"></asp:TextBox>
            <br />
            <asp:Label ID="Label12" runat="server" Text="4.基本技能和素质：" CssClass="label1"></asp:Label>
            <br />
            <asp:TextBox ID="prbSkill" runat="server" CssClass="textbox1" TextMode="MultiLine"
                ReadOnly="true"></asp:TextBox>
            <br />
            <asp:Label ID="Label13" runat="server" Text="5.个性特征：" CssClass="label1"></asp:Label>
            <br />
            <asp:TextBox ID="prbPersonality" runat="server" CssClass="textbox1" TextMode="MultiLine"
                ReadOnly="true"></asp:TextBox>
            <br />
            <asp:Label ID="Label14" runat="server" Text="6.体质条件： " CssClass="label1"></asp:Label>
            <br />
            <asp:TextBox ID="prbPhycond" runat="server" CssClass="textbox1" TextMode="MultiLine"
                ReadOnly="true"></asp:TextBox>
            <br />
            <br />
            ...
            <br />
            <asp:TextBox ID="prbWorkOutline" runat="server" CssClass="textbox1" TextMode="MultiLine"
                ReadOnly="true"></asp:TextBox>
            <br />
            <asp:Label ID="Label17" runat="server" Text="2.工作内容及工作要求：" CssClass="label1"></asp:Label>
            <br />
            <asp:TextBox ID="prbWorkContentRequest" runat="server" CssClass="textbox1" TextMode="MultiLine"
                ReadOnly="true"></asp:TextBox>
            <br />
            <br />
            ...
            <br />
            <asp:TextBox ID="prbPower" runat="server" CssClass="textbox1" TextMode="MultiLine"
                ReadOnly="true"></asp:TextBox>
            <br />
            <asp:Label ID="Label20" runat="server" Text="2.责任：" CssClass="label1"></asp:Label>
            <br />
            <asp:TextBox ID="prbResponse" runat="server" CssClass="textbox1" TextMode="MultiLine"
                ReadOnly="true"></asp:TextBox>
            <br />
            <br />
            ...
            <br />
            <asp:TextBox ID="prbDirectLeader" runat="server" CssClass="textbox1" TextMode="MultiLine"
                ReadOnly="true"></asp:TextBox>
            <br />
            <asp:Label ID="Label23" runat="server" Text="2.下属：" CssClass="label1"></asp:Label>
            <br />
            <asp:TextBox ID="prbSubordinate" runat="server" CssClass="textbox1" TextMode="MultiLine"
                ReadOnly="true"></asp:TextBox>
            <br />
            <asp:Label ID="Label24" runat="server" Text="3.同事：" CssClass="label1"></asp:Label>
            <br />
            <asp:TextBox ID="prbColleague" runat="server" CssClass="textbox1" TextMode="MultiLine"
                ReadOnly="true"></asp:TextBox>
            <br />
            <asp:Label ID="Label25" runat="server" Text="4.服务对象：" CssClass="label1"></asp:Label>
            <br />
            <asp:TextBox ID="prbServices" runat="server" CssClass="textbox1" TextMode="MultiLine"
                ReadOnly="true"></asp:TextBox>
            <br />
            <asp:Label ID="Label26" runat="server" Text="5.外部关系：" CssClass="label1"></asp:Label>
            <br />
            <asp:TextBox ID="prbRelations" runat="server" CssClass="textbox1" TextMode="MultiLine"
                ReadOnly="true"></asp:TextBox>
            <br />
            <br />
            <asp:Label ID="Label27" runat="server" Text="(五)工作环境" Style="font-size: 17px; font-weight: 600;
                text-align: left;"></asp:Label>
            <br />
            <asp:TextBox ID="prbWorkEnter" runat="server" CssClass="textbox1" TextMode="MultiLine"
                ReadOnly="true"></asp:TextBox>
            <br />
            <br />
            <asp:Label ID="Label28" runat="server" Text="(六)岗位考核" Style="font-size: 17px; font-weight: 600;
                text-align: left;"></asp:Label>
            <br />
            <asp:TextBox ID="prbPostAssess" runat="server" CssClass="textbox1" TextMode="MultiLine"
                ReadOnly="true"></asp:TextBox>
            <br />
            <br />
            <asp:Label ID="Label29" runat="server" Text="(七)其他约定" Style="font-size: 17px; font-weight: 600;
                text-align: left;"></asp:Label>
            <br />
            <asp:TextBox ID="prbOthers" runat="server" CssClass="textbox1" TextMode="MultiLine"
                ReadOnly="true"></asp:TextBox>
            <br />
            <br />
        </div>
    ...
    <div class="Hidden">
        ...
        <asp:Button ID="WriteComment" runat="server" Text="Button" OnClick="WriteComment_Click"
            Style="display: none" />
    </div>
    </form>
</body>
