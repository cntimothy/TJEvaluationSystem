<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MakeEvaluated.aspx.cs" Inherits="TJEvaluationSystem.Pages.FirstManagerPages.MakeEvaluated" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>制定被考评人名单</title>
    ...
    <script src="../../lib/ligerUI/js/plugins/ligerTextBox.js" type="text/javascript"></script>
    <script src="../../Script/FirstManager/MakeEvaluated.js" type="text/javascript"></script>
</head>
<body>
