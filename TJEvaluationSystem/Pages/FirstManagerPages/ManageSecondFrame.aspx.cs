...
{
    public partial class ManageSecondFrame : System.Web.UI.Page
    {
        ...
        protected void DownloadFile_Click(object sender, EventArgs e)
        {
            ...
            //Response.AddHeader("Content-Disposition", "attachment;filename=管理员信息模版.zip");
            string filename = Server.MapPath("../../App_GlobalResources/managerinfo.zip");
            //指定编码 防止中文文件名乱码 
